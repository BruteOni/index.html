...
const WELL_HEAL_COST = 100;                // Gold cost for well full heal
const WELL_BLESSING_COST = 150;            // Gold cost for well XP/drop blessings
const WELL_ENERGY50_COST = 50;             // Gold cost for 50-energy refill
const WELL_ENERGY100_COST = 100;           // Gold cost for 100-energy refill
const WELL_ENERGY_CAP_COST = 400;          // Gold cost for energy cap upgrade
const WELL_ENERGY250_COST = 500;           // Gold cost for unlimited-use energy refill
...
const CLASSES = {
    ...
    ninja: {
        ...
        skills: [
            // Index 0: Shuriken - base damage, 0 CD
            { name: 'Shuriken', type: 'attack', mult: 1.0, cd: 0, color: 'bg-gray-700', desc: 'Base damage (0 CD)' },
            // Index 1: Face Kick - base+100% + stun 1t + 10% vamp 3t, 7 CD
...
const SET_BONUS_DEFS = {
    ...
    ninja: {
        ascendant: {
            ...
            bonuses: {
                4:  '+10% damage increase',
                8:  '+10% vamp (lifesteal) increase',
                12: '+25% dodge chance',
                14: 'Decrease ALL skills cooldown by -1'
            }
        }
    },
    cleric: {
...
const ENEMIES_ZOMBIE = [
    { name: 'Stumbling Steve', avatar: '🧟', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Rotting Randy', avatar: '🧟‍♂️', hpMult: 1.1, dmgMult: 1.0 },
    { name: 'Braindead Bob', avatar: '🧟', hpMult: 0.9, dmgMult: 1.1 },
    { name: 'Moldy Mike', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 0.95 },
    { name: 'Drooling Dave', avatar: '🧟', hpMult: 1.05, dmgMult: 1.0 },
    { name: 'Shambling Sharon', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.05 },
    { name: 'Lurching Larry', avatar: '🧟‍♂️', hpMult: 1.15, dmgMult: 0.95 },
    { name: 'Groaning Greg', avatar: '🧟', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Decrepit Dan', avatar: '🧟‍♂️', hpMult: 1.2, dmgMult: 0.9 },
    { name: 'Putrid Pete', avatar: '🧟', hpMult: 0.95, dmgMult: 1.1 },
    { name: 'Festering Fiona', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Ghoulish Gary', avatar: '🧟‍♂️', hpMult: 1.05, dmgMult: 1.05 },
    { name: 'Necrotic Nick', avatar: '🧟', hpMult: 1.1, dmgMult: 0.9 },
    { name: 'Wormy Wendy', avatar: '🧟‍♀️', hpMult: 0.9, dmgMult: 1.15 },
    { name: 'Bonecrusher Bill', avatar: '🧟‍♂️', hpMult: 1.25, dmgMult: 1.1 },
    { name: 'Jawless Jake', avatar: '🧟', hpMult: 0.85, dmgMult: 1.2 },
    { name: 'Eyeless Eddie', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 0.85 },
    { name: 'Sludge Sam', avatar: '🧟', hpMult: 1.15, dmgMult: 1.0 },
    { name: 'Grimy Gus', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.05 },
    { name: 'Oozing Oscar', avatar: '🧟', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Cadaverous Carl', avatar: '🧟‍♂️', hpMult: 1.3, dmgMult: 0.9 },
    { name: 'Maggot Mary', avatar: '🧟‍♀️', hpMult: 0.9, dmgMult: 1.1 },
    { name: 'Rancid Rick', avatar: '🧟', hpMult: 1.05, dmgMult: 1.05 },
    { name: 'Bloated Brenda', avatar: '🧟‍♀️', hpMult: 1.2, dmgMult: 0.95 },
    { name: 'Skeletal Scott', avatar: '🧟‍♂️', hpMult: 0.85, dmgMult: 1.15 },
    { name: 'Tombstone Tim', avatar: '🧟', hpMult: 1.1, dmgMult: 1.0 },
    { name: 'Gravedigger Grace', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.1 },
    { name: 'Corpsewalker Craig', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Deathly Derek', avatar: '🧟', hpMult: 1.15, dmgMult: 0.95 },
    { name: 'Flesh-Eater Fred', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.2 },
    { name: 'Viscera Vicky', avatar: '🧟‍♀️', hpMult: 0.95, dmgMult: 1.0 },
    { name: 'Gutripper Gina', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.1 },
    { name: 'Brainmuncher Bruce', avatar: '🧟‍♂️', hpMult: 1.1, dmgMult: 1.05 },
    { name: 'Spleen Splitter Sal', avatar: '🧟', hpMult: 1.05, dmgMult: 1.1 },
    { name: 'Kneecapper Karen', avatar: '🧟‍♀️', hpMult: 0.9, dmgMult: 1.05 },
    { name: 'Zombified Zack', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 0.9 },
    { name: 'Headless Harry', avatar: '🧟', hpMult: 1.2, dmgMult: 1.0 },
    { name: 'One-Arm Al', avatar: '🧟‍♂️', hpMult: 0.9, dmgMult: 0.85 },
    { name: 'Legless Lou', avatar: '🧟', hpMult: 0.85, dmgMult: 0.9 },
    { name: 'Torso Tony', avatar: '🧟‍♂️', hpMult: 0.95, dmgMult: 0.95 },
    { name: 'Crawler Cathy', avatar: '🧟‍♀️', hpMult: 0.9, dmgMult: 1.0 },
    { name: 'Stitched Stan', avatar: '🧟‍♂️', hpMult: 1.15, dmgMult: 1.05 },
    { name: 'Patchwork Pat', avatar: '🧟', hpMult: 1.05, dmgMult: 1.0 },
    { name: 'Sewn-Up Sue', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 0.9 },
    { name: 'Franken-Frank', avatar: '🧟‍♂️', hpMult: 1.3, dmgMult: 1.1 },
    { name: 'Graveshift Gary', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Midnight Moe', avatar: '🧟', hpMult: 1.05, dmgMult: 1.05 },
    { name: 'Duskwalker Diane', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Nightcrawler Ned', avatar: '🧟‍♂️', hpMult: 0.95, dmgMult: 1.1 },
    { name: 'Moonlit Marge', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 0.95 },
    { name: 'Toxic Tommy', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.15 },
    { name: 'Plague-Bearer Paul', avatar: '🧟', hpMult: 1.1, dmgMult: 1.1 },
    { name: 'Infected Irene', avatar: '🧟‍♀️', hpMult: 0.95, dmgMult: 1.05 },
    { name: 'Viral Vinnie', avatar: '🧟‍♂️', hpMult: 1.05, dmgMult: 1.0 },
    { name: 'Contagious Connie', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Acidic Andy', avatar: '🧟‍♂️', hpMult: 0.9, dmgMult: 1.2 },
    { name: 'Slimy Simon', avatar: '🧟', hpMult: 1.0, dmgMult: 0.95 },
    { name: 'Mushy Mel', avatar: '🧟‍♀️', hpMult: 1.05, dmgMult: 1.0 },
    { name: 'Gooey Glen', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.05 },
    { name: 'Soggy Sophie', avatar: '🧟‍♀️', hpMult: 0.95, dmgMult: 1.0 },
    { name: 'Ancient Arthur', avatar: '🧟‍♂️', hpMult: 1.25, dmgMult: 1.05 },
    { name: 'Mummy Max', avatar: '🧟', hpMult: 1.2, dmgMult: 0.9 },
    { name: 'Dusty Dolores', avatar: '🧟‍♀️', hpMult: 1.1, dmgMult: 0.95 },
    { name: 'Ashen Archie', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Cursed Charlie', avatar: '🧟', hpMult: 1.1, dmgMult: 1.1 },
    { name: 'Howling Hank', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.05 },
    { name: 'Screaming Stella', avatar: '🧟‍♀️', hpMult: 0.9, dmgMult: 1.1 },
    { name: 'Wailing Walt', avatar: '🧟', hpMult: 1.05, dmgMult: 1.0 },
    { name: 'Moaning Mona', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 0.9 },
    { name: 'Shrieking Shelly', avatar: '🧟‍♀️', hpMult: 0.95, dmgMult: 1.15 },
    { name: 'Charred Chuck', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Crispy Chris', avatar: '🧟', hpMult: 0.9, dmgMult: 1.05 },
    { name: 'Ember Emma', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.1 },
    { name: 'Smokey Steve Jr', avatar: '🧟‍♂️', hpMult: 1.05, dmgMult: 1.0 },
    { name: 'Ashy Ash', avatar: '🧟', hpMult: 0.95, dmgMult: 0.95 },
    { name: 'Frozen Floyd', avatar: '🧟‍♂️', hpMult: 1.15, dmgMult: 0.9 },
    { name: 'Icy Ivan', avatar: '🧟', hpMult: 1.1, dmgMult: 0.85 },
    { name: 'Frostbite Fran', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Chilled Chester', avatar: '🧟‍♂️', hpMult: 1.05, dmgMult: 0.95 },
    { name: 'Glacial Gloria', avatar: '🧟‍♀️', hpMult: 1.2, dmgMult: 0.9 },
    { name: 'Thunder Thud', avatar: '🧟‍♂️', hpMult: 1.1, dmgMult: 1.1 },
    { name: 'Lightning Lars', avatar: '🧟', hpMult: 0.9, dmgMult: 1.2 },
    { name: 'Stormy Stan', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.05 },
    { name: 'Tempest Tina', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Cyclone Clyde', avatar: '🧟‍♂️', hpMult: 0.95, dmgMult: 1.1 },
    { name: 'Swamp Thing Seth', avatar: '🧟‍♂️', hpMult: 1.2, dmgMult: 1.0 },
    { name: 'Bog Beast Betty', avatar: '🧟‍♀️', hpMult: 1.15, dmgMult: 0.95 },
    { name: 'Marsh Monster Murray', avatar: '🧟‍♂️', hpMult: 1.1, dmgMult: 1.0 },
    { name: 'Reed Wraith Rita', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.05 },
    { name: 'Mire Marvin', avatar: '🧟', hpMult: 1.05, dmgMult: 1.0 },
    { name: 'Tunnel Troll Terry', avatar: '🧟‍♂️', hpMult: 1.25, dmgMult: 1.0 },
    { name: 'Sewer Sid', avatar: '🧟', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Drain Dweller Donna', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 0.95 },
    { name: 'Pipe Phantom Phil', avatar: '🧟‍♂️', hpMult: 0.9, dmgMult: 1.1 },
    { name: 'Gutter Gremlin Gail', avatar: '🧟‍♀️', hpMult: 0.85, dmgMult: 1.05 },
    { name: 'Parkour Zombie Zoe', avatar: '🧟‍♀️', hpMult: 0.9, dmgMult: 1.15 },
    { name: 'Sprinting Spencer', avatar: '🧟‍♂️', hpMult: 0.9, dmgMult: 1.2 },
    { name: 'Dashing Dennis', avatar: '🧟', hpMult: 0.95, dmgMult: 1.1 },
    { name: 'Vaulting Vera', avatar: '🧟‍♀️', hpMult: 0.9, dmgMult: 1.05 },
    { name: 'Leaping Lenny', avatar: '🧟‍♂️', hpMult: 0.95, dmgMult: 1.1 },
    { name: 'Chef Zombie Claude', avatar: '🧟‍♂️', hpMult: 1.0, dmgMult: 1.0 },
    { name: 'Baker Zombie Bella', avatar: '🧟‍♀️', hpMult: 1.05, dmgMult: 0.95 },
    { name: 'Butcher Zombie Boris', avatar: '🧟‍♂️', hpMult: 1.1, dmgMult: 1.1 },
    { name: 'Waiter Zombie Wayne', avatar: '🧟', hpMult: 0.95, dmgMult: 0.95 },
    { name: 'Barista Zombie Bea', avatar: '🧟‍♀️', hpMult: 1.0, dmgMult: 1.0 }
];

// --- ZOMBIE APOCALYPSE TITLES ---
const ZOMBIE_TITLES = [
    { id: 'scrambler', name: 'The Scrambler', wavesRequired: 10 },
    { id: 'survivor', name: 'The Survivor', wavesRequired: 20 },
    { id: 'undying', name: 'The Undying', wavesRequired: 30 },
    { id: 'reckless', name: 'The Reckless', wavesRequired: 40 },
    { id: 'corpse_crusher', name: 'The Corpse Crusher', wavesRequired: 50 },
    { id: 'apocalypse_walker', name: 'The Apocalypse Walker', wavesRequired: 60 },
    { id: 'unkillable', name: 'The Unkillable', wavesRequired: 70 },
    { id: 'last_stand', name: 'The Last Stand', wavesRequired: 80 },
