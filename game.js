...
let globalProgression = {
    ...
    inventory: { ench_common: 0, ench_rare: 0, ench_epic: 0, ench_legendary: 0, herb_red: 0, herb_blue: 0, fish_1: 0, fish_2: 0, fish_3: 0, fish_4: 0, fish_5: 0, fish_6: 0, soul_pebbles: 0, pot_i1: 30, pot_i2: 0, pot_i3: 0, pot_r1: 0, pot_r2: 0, pot_r3: 0, food_d1: 0, food_d2: 0, food_d3: 0, food_df1: 0, food_df2: 0, food_df3: 0, magic_stone: 0, ethereal_dust: 0 },
    usableItems: {},
...
function showMenu() { 
    try { stopMusic(); } catch(e) { console.error('Failed to stop music:', e); } 
    const contBtn = document.getElementById('btn-continue-save');
    if (contBtn) contBtn.classList.toggle('hidden', !LEGACY_SAVE_KEYS.some(k => localStorage.getItem(k)));
    switchScreen('screen-menu'); 
}
